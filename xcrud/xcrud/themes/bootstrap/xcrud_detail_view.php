...
<div class="xcrud-top-actions btn-group">
 ...
 if($this->is_next_previous){
	 echo $this->render_previous('Previous','edit','','btn btn-primary xcrud-button xcrud-green','','edit');
	 echo $this->details_counter();    
	 echo $this->render_next('Next','edit','','btn btn-primary xcrud-button xcrud-green','','edit');
 }
 ?>
</div>
 <div class="xcrud-top-actions btn-group">
