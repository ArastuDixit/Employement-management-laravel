...
{
    // default connection
    public static $dbname = 'technz1m_larala'; // Your database name
    public static $dbuser = 'technz1m_larala'; // Your database username
    public static $dbpass = 'technz1m_larala'; // // Your database password
