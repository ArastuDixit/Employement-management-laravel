                        ...
                        <div class="white_card_header">
                           <div class="box_header m-0">
                              ...
                              <div class="float-lg-right float-none common_tab_btn2 justify-content-end">
                                 <ul class="nav">
                                    <li class="nav-item">
                                       <a class="nav-link" href="{{$admin_path}}dashboard#">Month</a>
                                    </li>
                                    <li class="nav-item">
                                       <a class="nav-link active" href="{{$admin_path}}dashboard#">Week</a>
                                    </li>
                                    <li class="nav-item">
                                       <a class="nav-link" href="{{$admin_path}}dashboard#">Day</a>
                                    </li>
                                 </ul>
                              </div>
                           </div>
                  ...
                  <div class="col-xl-4 ">
                     <div class="white_card card_height_100 mb_30 social_media_card">
                        ...
                        <div class="media_thumb ml_25">
                           <img src="{{$admin_asset_path}}img/media.svg" alt="">
                        </div>
                           ...
                           <div class="monthly_plan_wraper">
                              <div class="single_plan d-flex align-items-center justify-content-between">
                                 <div class="plan_left d-flex align-items-center">
                                    <div class="thumb">
                                       <img src="{{$admin_asset_path}}img/crome.png" alt="">
                                    </div>
                                    <div>
                                       <h5>Chrome Users</h5>
                                       <span>Today</span>
                              ...
                              <div class="single_plan d-flex align-items-center justify-content-between">
                                 <div class="plan_left d-flex align-items-center">
                                    <div class="thumb">
                                       <img src="{{$admin_asset_path}}img/safari.png" alt="">
                                    </div>
                                    <div>
                                       <h5>Chrome Users</h5>
                                       <span>Today</span>
                              ...
                              <div class="single_plan d-flex align-items-center justify-content-between">
                                 <div class="plan_left d-flex align-items-center">
                                    <div class="thumb">
                                       <img src="{{$admin_asset_path}}img/OBJECTS.png" alt="">
                                    </div>
                                    <div>
                                       <h5>Chrome Users</h5>
                                       <span>Today</span>
                     ...
                     <div class="white_card card_height_100 mb_30">
                        ...
                        <div class="white_card_body ">
                           ...
                           <div class="devices_btn text-center">
                              <a class="color_button color_button2" href="{{$admin_path}}dashboard#">Android</a>
                              <a class="color_button" href="{{$admin_path}}dashboard#">iphone</a>
                              <a class="color_button color_button3" href="{{$admin_path}}dashboard#">Others</a>
                           </div>
                        </div>
                     </div>
                  </div>
                                       ...
                                       <tbody>
                                          <tr>
                                             ...
                                             <td class="f_s_14 f_w_400 color_text_3">
                                                <a href="{{$admin_path}}dashboard#" class="badge_active">Active</a>
                                             </td>
                                             <td>
                                                <div class="action_btns d-flex">
                                                   <a href="{{$admin_path}}dashboard#" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                                   <a href="{{$admin_path}}dashboard#" class="action_btn"> <i class="fas fa-trash"></i> </a>
                                                </div>
                                             </td>
                                          </tr>
                                          <tr>
                                             ...
                                             <td class="f_s_14 f_w_400 color_text_3">
                                                <a href="{{$admin_path}}dashboard#" class="badge_active2">Posed</a>
                                             </td>
                                             <td>
                                                <div class="action_btns d-flex">
                                                   <a href="{{$admin_path}}dashboard#" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                          ...
                                          <tr>
                                             ...
                                             <td class="f_s_14 f_w_400 color_text_3">
                                                <a href="{{$admin_path}}dashboard#" class="badge_active3">Closed</a>
                                             </td>
                                             <td>
                                                <div class="action_btns d-flex">
                                                   <a href="{{$admin_path}}dashboard#" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                                          ...
                                          <tr>
                                             ...
                                             <td class="f_s_14 f_w_400 color_text_3">
                                                <a href="{{$admin_path}}dashboard#" class="badge_active4">End soon</a>
                                             </td>
                                             <td>
                                                <div class="action_btns d-flex">
                                                   <a href="{{$admin_path}}dashboard#" class="action_btn mr_10"> <i class="far fa-edit"></i> </a>
                        ...
                        <div class="white_card_body QA_section">
                           <div class="todo_wrapper">
                              <div class="single_todo d-flex justify-content-between align-items-center">
                                 ...
                                 <div class="lodo_right"> <a href="{{$admin_path}}dashboard#" class="badge_complete">Complete</a> </div>
                              </div>
                              <div class="single_todo d-flex justify-content-between align-items-center">
                                 <div class="lodo_left d-flex align-items-center">
                                 ...
                                 <div class="lodo_right"> <a href="{{$admin_path}}dashboard#" class="mark_complete">Mark as completed</a> </div>
                              </div>
                              <div class="single_todo d-flex justify-content-between align-items-center">
                                 <div class="lodo_left d-flex align-items-center">
                                    <div class="bar_line red_line mr_10"></div>
                           ...
                           <div class="row height_100">
                              <div class="col-lg-6">
                                 ...
                                 <div class="weather_img_1 mt_30">
                                    <img class="img-fluid" src="{{$admin_asset_path}}img/man.png" alt="">
                                 </div>
                              </div>
                              <div class="col-lg-6">
